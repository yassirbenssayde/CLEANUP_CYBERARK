########################################################################################################################################
#Lister les coffres qui ont d'owners, lister leur compte.
...
foreach ($safe in $safes) {
    ...
    if ($safe.SafeName -like "safe-*") {
        ...
        # Si un membre correspondant est trouvé
...
$result |  Export-Csv -Path "D:\Test\EmptyAccountsSafeMembersPREPROD20230531.csv" -NoTypeInformation 
########################################################################################################################################